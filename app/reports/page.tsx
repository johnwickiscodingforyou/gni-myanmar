    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6">
        ...
        <div className="bg-gray-900 border border-gray-700 rounded-xl p-4 mb-4">
          <p className="text-sm text-gray-200 leading-relaxed">{mm.reports_intro}</p>
        </div>
      ...
      <footer className="border-t border-gray-800 mt-8">
        <div className="max-w-5xl mx-auto px-4 py-4 text-center text-xs text-gray-600">GNI Myanmar | Intelligence Reports | Higher Diploma in Computer Science | Spring University Myanmar (SUM)</div>
      </footer>
    </div>
  )
}
